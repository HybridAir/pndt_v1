...
FLAGS_GCC = -c -g -Os -Wall -ffunction-sections -fdata-sections -mmcu=${ARDUINO_MODEL} -DF_CPU=16000000L -MMD -DUSB_VID=2341 -DUSB_PID=8036 -DARDUINO=${ARDUINO_VERSION}
...
.build-post: .build-impl
	...
	${AVR_DUDE} -v -p${ARDUINO_MODEL} -c${ARDUINO_PROGRAMMER} -P ${COM_PORT} -U flash:w:${CND_ARTIFACT_PATH_${CONF}}.hex:i
